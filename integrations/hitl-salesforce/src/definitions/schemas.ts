...
export const SFMessagingConfigSchema = z
  .object({
    endpoint: z.string({
...
export const MessagingSessionSchema = z
  .object({
...
export const SSESessionSchema = z
  .object({
...
export const CreateTTSessionResponseSchema = z
  .object({
    success: z.boolean(),
    data: z.object({
      key: z.string()
